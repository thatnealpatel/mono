...
// Package uuid is an unsafe, unblessed copy of the go1.27
// uuid package for use in my own Go modules while it remains
// unreleased (as of aed01950e0 in the main Go repository).
//
// You should ABSOLUTELY NOT use this package for any reason,
// and it WILL be removed as soon as uuid is available in std.
package uuid
